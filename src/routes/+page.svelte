<script>
    ...
    let academics =`h-48 flex flex-col relative`
</script>
...
<section id="carousel">
    ...
    <div class="h-[560px] bg-indigo-900 bg-opacity-0 w-full relative">
        ...
        <div class="absolute left-0 top-0 w-full h-[480px] pane">
            <div class="relative h-full ml-8 md:ml-28">
                <div class="flex h-full items-center w-fit absolute bottom-0 ">
                    <img class = "hidden md:block image h-40 xl:h-48 opacity-80 w-fit mx-auto" src="/png/BW.png" alt="nithalos international school logo">
        ...
        <!-- <div class="absolute right-0 top-0 h-[480px]">
...
<section class="Academics">
    <div class="w-full px-2 sm:px-8 pt-10 pb-6 sm:pb-10  mt-0 space-x-0 sm:space-x-6 xl:w-5/6 mx-auto flex">

        <div class="secondary h-96  bg-blue-50 mt-8 relative shadow-lg border-t-4 border-yellow-400" style="width:32%">
        ...
        <div class="primary h-[450px] bg-red-5 bg-[#5e5fb9] relative shadow-xl" style="width:36%">
            <div class="flex pt-4 px-4 space-x-1 border-t-4 border-white">
                <div class="w-fit mx-auto flex space-x-1">
                    ...
                    <p class="font-extrabold text-lg md:text-xl font-serif text-white tracking-wider">Primary</p>
                </div>
            </div>
...
<section class="About bg-blue-50">
    <div class="flex py-10 md:w-full md:px-8 xl:w-4/6 mx-auto">
        <div class="h-40 w-full px-2 md:w-3/5 md:px-0 bg-blue-50">
            <div class="pt-4 font-extrabold text-xl text-center font-serif text-blue-900 ">About NIS</div>
            <div class="text-center pr-2 pl-2 md:pl-0 md:pr-6 text-xs lg:text-sm pt-2 age tracking-wide text-blue-900">Nithalos International School prides itself on providing the right environment needed for every child to set and reach their future professional and personal goals. At NIS, we are creating future leaders of the next generation with qualities such as critical thinking, a strong resolve, and a duty to stand for what is good and right. All of these are executed at the highest levels of quality, confidence and excellence.</div>
        </div>
...
<section class="hidden md:block">
    ...
    <div class="w-full h-32 bg-blue-600">
        <div class="flex h-full">
            <div class="w-1/4 flex items-center justify-center h-full bg-yellow-400 text-black">
                <div class="text-xl">Nithalos International<br><span class="text-xl font-bold tracking-widest font-f1">School</span></div>

            </div>
            <div class="w-2/4 h-full flex justify-center items-center">
                <div class="text-blue-50 font-f1 text-base tracking-wider ">
                    "At Nithalos every child matters"
                </div>
            </div>
            <div class="w-1/4 h-full flex justify-center items-center pr-8">
                <div class="text-xs tracking-tight w-fit h-fit bg-white text-stone-600 px-3 py-3 rounded-2xl font-semibold font-f1 cursor-pointer hover:text-white hover:bg-blue-900 transition duration-150">Make Inquiry Today</div>
            </div>
        </div>
    </div>
...
<section class="mb-10 lg:my-10 ">
    <div class="h-auto  w-full xl:w-5/6  mx-auto grid xl:px-4 gap-x-6 grid-cols-1 lg:grid-cols-3 ">
        ...
        <div class="contacts-div h-64 lg:h-full bg-white lg:bg-slate-50 lg:shadow-md">
            <div class="flex flex-col h-full w-2/3 lg:w-full mx-auto">
                <div class="h-1/5 px-4 flex items-center font-serif font-bold text-xl w-fit mx-auto lg:w-full text-blue-900 border-b border-slate-100">Contacts:</div>
                <div class="h-1/6 border-b flex border-slate-100 px-4 items-center">
                    ...
                    <p class="text-xs w-2/3 text-blue-800">78 Obiwali Rd, Rumuigbo 500272, Port Harcourt.</p>
                </div>
                <div class="h-1/6 border-b flex border-slate-100 px-4 items-center">
                    <div class="text-xs w-1/3 flex items-center text-slate-500 ">
                    ...
                    <p class="text-xs w-2/3 text-blue-800">+234 555 5555</p>
                </div>
                <div class="h-1/6 border-b flex border-slate-100 px-4 items-center">
                    ...
                    <p class="text-xs w-2/3 text-blue-800">sample@gmail.com</p>
                </div>
                <div class="h-1/6 border-b flex border-slate-100 px-4 items-center">
                    ...
                    <p class="text-xs w-2/3 text-blue-800">nis.facebook.com</p>
                </div>
...
<section class="hidden md:block my-10">
    <div class="w-full h-32 bg-green-900 flex items-center relative">
        <div class="absolute w-full flex justify-end items-center pr-32">
            <img src="png/BW.png" class="h-24 aspect-auto opacity-80" alt="">

        </div>
        <div class="w-fit h-fit text-blue-50 text-sm font-f1 mx-auto">
            "In working together, we create our own culture. A culture built of quality, confidence and excellence."</div>
    </div>
</section>
